...
- [ ] **Local-First (I)**: No cloud-only dependencies for core flows
- [ ] **Source-Grounded (II)**: Feature preserves cite-or-admit-unknown behavior
...
Re-evaluate all Pre-Design Gates after Phase 1 design. Document any violations in
Complexity Tracking below with justification.
